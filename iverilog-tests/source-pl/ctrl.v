...
// j format
    ...
    wire i_jalr = ~Funct3[2] & ~Funct3[1] & ~Funct3[0] & Op[6] & Op[5] & ~Op[4] & ~Op[3] & Op[2] & Op[1] & Op[0];        // jalr 000 1100111
...
// ALUOp_sra   5'b10001
    ...
    assign ALUOp[3] = i_and | i_andi | i_or | i_ori | i_sll | i_slli | i_xor | i_xori | i_bltu | i_bgeu | i_slt | i_slti | i_sltu | i_sltiu;
    ...
    assign ALUOp[1] = i_addi | i_add | i_and | i_andi | i_sll | i_slli | itype_l | stype | i_slt | i_slti | i_sltu | i_sltiu | i_blt | i_bge;
	  assign ALUOp[0] = i_addi | i_add | i_or | i_ori | LUI | i_sll | i_slli | i_sra | i_srai | itype_l | stype | i_bne | i_bge | i_bgeu | i_sltu | i_sltiu;
